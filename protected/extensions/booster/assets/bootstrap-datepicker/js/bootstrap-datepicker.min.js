!function ($) {
    ...
    Datepicker.prototype = {constructor: Datepicker, _process_options: function (opts) {
        ...
        this.element.trigger({type: event, date: local_date, format: $.proxy(function (altformat) {
