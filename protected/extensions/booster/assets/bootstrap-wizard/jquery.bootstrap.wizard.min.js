...
(function (e) {
    var k = function (d, g) {
        ...
        this.fixNavigationButtons = function () {
            ...
            a.rebindClick(e(b.nextSelector, d), a.next);
            a.rebindClick(e(b.previousSelector,
                d), a.previous);
        ...
        this.next = function (h) {
            ...
            $index = a.nextIndex();
            $index > a.navigationLength() || c.find("li:eq(" + $index + ") a").tab("show")
        };
        this.previous = function (h) {
            if (d.hasClass("first") || b.onPrevious && "function" === typeof b.onPrevious &&
                !1 === b.onPrevious(f, c, a.previousIndex()))return!1;
        ...
        this.last = function (h) {
            if (b.onLast && "function" === typeof b.onLast && !1 === b.onLast(f, c, a.lastIndex()) || d.hasClass("disabled"))return!1;
            c.find("li:eq(" + a.navigationLength() + ") a").tab("show")
        };
        this.currentIndex =
            function () {
        ...
        this.getIndex = function (a) {
            return c.find("li").index(a)
        };
        this.nextIndex = function () {
            return c.find("li").index(f) + 1
        };
        this.previousIndex = function () {
            return c.find("li").index(f) - 1
        };
        this.navigationLength = function () {
            return c.find("li").length - 1
        };
        this.activeTab = function () {
            return f
        };
        this.nextTab = function () {
            return c.find("li:eq(" + (a.currentIndex() + 1) + ")").length ? c.find("li:eq(" +
                (a.currentIndex() + 1) + ")") : null
        };
        this.previousTab = function () {
            return 0 >= a.currentIndex() ? null : c.find("li:eq(" + parseInt(a.currentIndex() - 1) + ")")
        };
        this.show = function (a) {
            return d.find("li:eq(" + a + ") a").tab("show")
        };
        this.disable = function (a) {
            c.find("li:eq(" + a + ")").addClass("disabled")
        };
        this.enable = function (a) {
            c.find("li:eq(" + a + ")").removeClass("disabled")
        };
        ...
        e('a[data-toggle="tab"]', c).on("click", function (d) {
            ...
            if (b.onTabClick && "function" === typeof b.onTabClick &&
                !1 === b.onTabClick(f, c, a.currentIndex(), d))return!1
        });
        e('a[data-toggle="tab"]', c).on("shown", function (d) {
            $element = e(d.target).parent();
            d = c.find("li").index($element);
