	...
	<div class="col-xs-8 col-xs-offset-2" id="add-comment">
		...
		<div class="row">
			<div class="col-xs-8">
				...
				<?= $form->textField($model, 'email', array('class' => 'form-control', 'placeholder' => 'Name', 'style' => 'border-radius:10px 10px 0 0;border-bottom:none;', 'value' => (!Yii::app()->user->isGuest) ? Yii::app()->user->email : '')); ?>
			</div>
			<div class="btn"
				 style="padding-top: 7px; border-radius: 10px 10px 0 0; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.3) inset">
